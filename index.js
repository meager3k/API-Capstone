const filmographyURL = 'https://api.themoviedb.org/3/person/{person_id}/combined_credits?api_key=07739c64272d95a7716a3647ba7f3bc4&language=en-US';

function getActorDataFromApi(searchTerm, callback) {
  const settings = {
    "async": true,
    "crossDomain": true,
    "url": `https://api.themoviedb.org/3/search/person?api_key=07739c64272d95a7716a3647ba7f3bc4&language=en-US&query=${searchTerm}&page=1&include_adult=false`,
    "method": "GET",
    "data": "{}",
  }
